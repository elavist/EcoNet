...
**Версия:** 1.2 (GPU Full Power + Veins Integration)  
...
3. [GPU-оптимизации (v1.2)](#gpu-оптимизации-v12)
4. [Нейронная архитектура](#нейронная-архитектура)
5. [SwarmOS — полевая архитектура роя](#swarmos--полевая-архитектура-роя)
6. [GPU Veins — кровообращение](#gpu-veins--кровообращение)
7. [DeepSeek LLM](#deepseek-llm)
8. [Документация по модулям](#документация-по-модулям)
9. [API](#api)
10. [Конфигурация](#конфигурация)
11. [Тестирование](#тестирование)
12. [Текущий статус](#текущий-статус)
13. [История версий](#история-версий)
